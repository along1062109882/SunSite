...
class Annuals extends Common
{
    ...
    public function annual_commit(){
        ...
        if (isset($id) && !empty($id)) {
            ...
            if($posts->save()){
                Content::update(['data'=>$data['title_hk']],['owner_id'=>$data['id'],'language'=>0,'owner_type'=>'annual','owner_field'=>'Name']);
                Content::update(['data'=>$data['title_cn']],['owner_id'=>$data['id'],'language'=>1,'owner_type'=>'annual','owner_field'=>'Name']);
                Content::update(['data'=>$data['title_en']],['owner_id'=>$data['id'],'language'=>2,'owner_type'=>'annual','owner_field'=>'Name']);
                Content::update(['data'=>$data['content_hk']],['owner_id'=>$data['id'],'language'=>0,'owner_type'=>'annual','owner_field'=>'Content']);
                Content::update(['data'=>$data['content_cn']],['owner_id'=>$data['id'],'language'=>1,'owner_type'=>'annual','owner_field'=>'Content']);
                Content::update(['data'=>$data['content_en']],['owner_id'=>$data['id'],'language'=>2,'owner_type'=>'annual','owner_field'=>'Content']);
