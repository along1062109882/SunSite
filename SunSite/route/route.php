...
Route::get('/zh-hans/jobUpload', 'index/jobUpload');
Route::get('/zh-hans/jobCommit', 'index/jobCommit');
...
Route::get('/zh-hant/jobUpload', 'index/jobUpload');
Route::get('/zh-hant/jobCommit', 'index/jobCommit');
